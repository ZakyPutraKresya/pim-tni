...
const About = () => {
    ...
    const forewordData = {
      ...
      const missionData = {
        title: "Our Mission",
        paragraph: "The IFC is to collect and sense-make relevant White Shipping and maritime information in its Area of Interest, in order to produce accurate, reliable, impartial and actionable MARSEC information for related OPCENs and the shipping community, to achieve Safe and Secure Seas for All.",
      };
      const visionData = {
        title: "Our Vision",
        paragraph: "To be the centre of excellence for fusion and exchange of actionable maritime security information in the IFC's Area of Interest",
      };
      const newsData = {
        title: "Our Journey",
        newsItems: [
    ...
    <div className={styles.body}>
        ...
        <Navbar />
        <CarouselSmall headerImg={carouselImg}/>
